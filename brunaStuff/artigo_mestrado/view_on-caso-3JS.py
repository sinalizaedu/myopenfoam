...
Visualizacao rapida do Caso 3J (geometria em "J" + cargas 3F):
  - le os nos de REFERENCIA da malja varrida (on-caso-3JS_mesh.inp)
...
Uso: brunaStuff/.venv/bin/python brunaStuff/view_on-caso-3JS.py
"""
...
fig.suptitle(f"Caso 3JS - geometria em \"S\" IMPOSTA + cargas 3F "
...
ax.scatter(R[:, 0] * mm, R[:, 1] * mm, s=3, c="0.75",
           label="referencia (S imposto)", zorder=1)
...
ax.set_title("(A) Plano do \"S\" (XY): referencia vs deformado")
